...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
...

		{
			...
			ImGui::RadioButton("orthographic", &mode, 2);
			ImGui::Separator();
			ImGui::Text("Camera position");
			ImGui::SliderFloat("camera.x", &camPos[0], -10.0f, 10.0f);
			ImGui::SliderFloat("camera.y", &camPos[1], -10.0f, 10.0f);
			ImGui::SliderFloat("camera.z", &camPos[2], -10.0f, 10.0f);
			ImGui::Separator();
			ImGui::Text("Lamp position");
			ImGui::SliderFloat("lamp.x", &lightPos.x, -10.0f, 10.0f);
			ImGui::SliderFloat("lamp.y", &lightPos.y, -10.0f, 10.0f);
			ImGui::SliderFloat("lamp.z", &lightPos.z, -10.0f, 10.0f);
			ImGui::Separator();
			ImGui::Text("Cube position");
			ImGui::SliderFloat("cube.x", &cubePosition.x, -3.0f, 3.0f);
			ImGui::SliderFloat("cube.y", &cubePosition.y, -3.0f, 3.0f);
			ImGui::SliderFloat("cube.z", &cubePosition.z, -3.0f, 3.0f);
